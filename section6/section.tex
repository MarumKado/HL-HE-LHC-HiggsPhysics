...
\asection[A. Magnan, B. Nachman, T. Robens and T. Stefaniak]{Invisible decays of the Higgs boson}\label{Sec:6Invisible}
...
\asubsection{Main channels for direct searches}\label{sec:expinp}
...
\asubsection{Interpretation and combination with precision Higgs boson measurements}
\asubsubsection{Experimental input}
\label{sec6:exp}
...
\asubsubsection{Effective description of Higgs portal models}
\label{sec6:effC}
...
\asubsection{Higgs portal interpretations}

\asubsubsection{Minimal Higgs Portal}
...
\asubsubsection{Scalar singlet portal}
