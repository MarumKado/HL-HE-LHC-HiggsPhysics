...
We implemented the CMS HL projections for Higgs signal strength measurements for the individual production times decay modes (see Section~\ref{sec:2:exp_combination})
...
We consider both scenarios S1 and S2. These scenarios differ in the treatment of systematic uncertainties. In S1, systematic uncertainties are unchanged {with respect to current values}; S2 employs rescaled experimental systematic uncertainties~\cite{HLHELHCCommonSystematics}
...
\end{align}
After electroweak symmetry breaking the scalar $\mathrm{SU}(2)_L$ doublet field $\Phi$ is given by 
