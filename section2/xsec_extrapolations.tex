...
\asubsubsection{Cross sections for 13, 14 and 27 \UTeV HE-LHC}
\label{sec:he-lhc}
...
\asubsubsubsection{Gluon fusion}
...
small shift in the cross-section at 13~\UTeV, relative to the YR4 result, and
...
\begin{center}
    \begin{tabular}{rrrrr}
        ...
        \midrule
13 \UTeV & 48.61 pb & ${}^{+2.08\textrm{pb}}_{-3.15\textrm{pb}}\,\left({}^{+4.27\%}_{-6.49\%}\right) $ & $\pm\,0.89\,\textrm{pb}\,(\pm\,1.85\%)$ & ${}^{+1.24\textrm{pb}}_{-1.26\textrm{pb}}\,\left({}^{+2.59\%}_{-2.62\%}\right) $ \\%\midrule
14 \UTeV & 54.72 pb & ${}^{+2.35\textrm{pb}}_{-3.54\textrm{pb}}\,\left({}^{+4.28\%}_{-6.46\%}\right) $ & $\pm\,1.00\,\textrm{pb}\,(\pm\,1.85\%)$ & ${}^{+1.40\textrm{pb}}_{-1.41\textrm{pb}}\,\left({}^{+2.60\%}_{-2.62\%}\right) $ \\%\midrule
...
\noindent The dependence of the inclusive gluon-fusion cross-section on the Higgs boson mass at $\sqrt{s}=14$ and 27~\UTeV
...
\item The parton densities receive a large correction from small-$x$
  ...
  Ref.~\cite{Bonvini:2018ixe} (\texttt{NNPDF31sx\allowbreak\_nnlonllx\allowbreak\_as\allowbreak\_0118}
...
\asubsubsubsection{Vector boson fusion}
...
\asubsubsubsection{VH production}
\label{sec:he-lhc-VH}
\begin{table}
\centering
\begin{tabular}{ccccc}
...
\asubsubsubsection{$t\bar t H$ and $tH$}
\label{sec:he-lhc-ttH}
Cross sections for $t\bar{t}H$ and $tH+\bar{t}H$ production at
$\sqrt{s}=14$ and 27~\UTeV are presented in Tables~\ref{tab:ttH13_xsec}-\ref{tab:ttH27_xsec}
and Tables~\ref{tab:tH13_xsec}-\ref{tab:tH27_xsec} respectively. Results have been obtained using the same setup as
...
\midrule
$124.59$ & $512.2$ & $^{+5.8}_{-9.2}$ & $2.0$ & $3.0$ & $3.6$ \\
$125.09$ & $506.5$ & $^{+5.8}_{-9.2}$ & $2.0$ & $3.0$ & $3.6$ \\
$125.59$ & $500.7$ & $^{+5.8}_{-9.2}$ & $2.0$ & $3.0$ & $3.6$ \\
\bottomrule
\end{tabular}%
\caption{NLO QCD+EW cross sections for $t\bar tH$ production at the 13 \UTeV LHC, taken from Ref.~\cite{deFlorian:2016spz}.}
\label{tab:ttH13_xsec}
\end{table}
%
\begin{table}
\centering
...
\midrule
$124.59$ & $74.52$ & $^{+6.6}_{-14.7}$ & $1.2$ & $3.5$ & $3.7$ & $49.04$ & $25.49$\\
$125.09$ & $74.26$ & $^{+6.5}_{-14.7}$ & $1.2$ & $3.5$ & $3.7$ & $48.89$ & $25.40$\\
$125.59$ & $74.09$ & $^{+6.5}_{-15.2}$ & $1.2$ & $3.6$ & $3.7$ & $48.75$ & $25.32$\\
\bottomrule
\end{tabular}%
\caption{NLO QCD cross sections for the $t-$channel $tH$ and $\bar t H$
production at the 13 \UTeV LHC, taken from Ref.~\cite{deFlorian:2016spz}.}
\label{tab:tH13_xsec}
\end{table}
%
\begin{table}
...
\asubsubsection{Projections of uncertainty reductions for the HL-LHC}
\label{sec:hl-lhc}
...
\asubsubsubsection{$VH$ production}
\label{sec:hl-lhc-VH}
The Higgs couplings to $W$ and $Z$ bosons are related by $SU(2)_L$ gauge invariance. As such, the measurement of the Higgs associated production with a $W$ or a $Z$ is complementary to the vector boson fusion process, as first considered in $e^+e^−$ colliders in Ref. \cite{Jones:1979bq}.
...
will allow one to assess this issue in the forthcoming
...
\asubsubsection{Predictions for boosted Higgs production}
...
predictions have the same accuracy as the ones in Fig.~\ref{fig:boosted13}. The $ggF$ prediction contains exact LO mass effects rescaled
...
Radiative corrections enhance the relative importance of the $ggF$ and $t\bar t H$ channels, which still dominate over VBF well into the
...
\asubsubsection{Dependence of gluon-fusion cross section  at $14$ and $27$ \UTeV on $m_H$}
\label{sec:ggFmhdep}
...
\end{equation}
\end{center}
\caption{The gluon-fusion cross-section in $pp$ collisions at $\sqrt{s}=27$~\UTeV, for different values of the Higgs boson mass $m_H$. \label{ggF:27TeV}}
\end{table}
