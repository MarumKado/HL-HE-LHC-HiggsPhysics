...
\asubsubsection[M. Mlynarikova, L. Thomsen]{$H \to \tau^{+}\tau^{-}$}
%\begin{center}
...
\asubsubsection[L. D'eramo, C. Li, G. Marchiori, A. de Wit]{$H \to b\bar{b}$}
%\begin{center}
...
\asubsubsection[M. Klute, H. Li, G. Marchiori, A.Marini, M. Verducci, M. Zgubic, J. Zhang]{$H \to \mu^{+}\mu^{-}$}\label{Sec:2.3.8}
%\begin{center}
...
Table \ref{tab:hmumu_proj} shows the expected precision on the signal strength (ATLAS) and branching fraction (CMS) measurement with 3000\fbinv of HL-LHC data in the scenarios S1 and S2.
...
rates of processes with two b-tags by the change in b-tagging efficiency squared. The modifications are applied only to the efficiency to select genuine b-jets; the mis-tagging rates for light quark and gluon jets remain unchanged.
