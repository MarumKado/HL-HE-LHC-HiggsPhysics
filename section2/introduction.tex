...
The kappa-framework is closely related to a non-linear EFT, and projections of measurements of EFT coefficients in a non-linear EFT are presented in Section~\ref{sec2:theo_kappa_EFT}. 
