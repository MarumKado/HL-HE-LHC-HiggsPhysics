...
%%
The projection of the $\pTH$ spectrum measurement by the CMS Collaboration is shown in Fig.~\ref{fig:proj_pth}, for both scenarios S1 and S2. The corresponding relative uncertainties are respectively given in Tables~\ref{tab:proj_pth_unc_scen1} and \ref{tab:proj_pth_unc_scen2}. With respect to the uncertainties at the current integrated luminosity of 35.9\fbinv, the uncertainties at 3000\fbinv in the higher $\pTH$ region are about a factor of ten smaller. This is expected, as the uncertainties in this region remain statistically dominated.
% 
...
\begin{table}
  ...
  \resizebox{\textwidth}{!}{
  \centering
  \begin{tabular}{l|cccccc|c|c|c|c|c|c|c|c}
    ...
    \hline
    \multicolumn{15}{c}{ATLAS}                                                                                                                                                                                       \\
    \hline
    $\pTH$ [GeV] & \multicolumn{2}{c|}{0-10}  & \multicolumn{2}{c|}{10-20} & \multicolumn{2}{c|}{20-30} & 30-45                      & 45-60  & 60-80   & 80-120  & 120-200 & 200-350 & \multicolumn{2}{c}{350-1000} \\
    \hline
    $\hgg$       &                                                                                                                                                                                                   \\
    $\hzz$       &                                                                                                                                                                                                   \\
    Combination  &                                                                                                                                                                                                   \\
    \hline
    \multicolumn{15}{c}{CMS}                                                                                                                                                                                         \\
    \hline
    $\pTH$ [GeV] & \multicolumn{3}{c|}{0-15}  & \multicolumn{3}{c|}{15-30} & 30-45                      & \multicolumn{2}{c|}{45-80} & 80-120 & 120-200 & 200-350 & 350-600 & 600-$\infty$                           \\
    \hline
    $\hgg$       & \multicolumn{3}{c|}{5.1\%} & \multicolumn{3}{c|}{6.8\%} & 7.1\%                      & \multicolumn{2}{c|}{6.9\%} & 7.1\%  & 6.7\%   & 7.1\%   & 9.9\%   & 32.5\%                                 \\     
    $\hzz$       & \multicolumn{3}{c|}{5.4\%} & \multicolumn{3}{c|}{5.7\%} & \multicolumn{3}{c|}{5.0\%} & \multicolumn{2}{c|}{5.5\%} & \multicolumn{3}{c}{9.6\%}                                                     \\ 
    $\hbb$       & \multicolumn{12}{c|}{none} & 38.2\%                     & 37.1\%                                                                                                                                  \\ 
    Combination  & \multicolumn{3}{c|}{3.7\%} & \multicolumn{3}{c|}{4.4\%} & 5.0\%                      & \multicolumn{2}{c|}{4.7\%} & 4.8\%  & 4.7\%   & 5.2\%   & 8.5\%   & 25.4\%                                 \\
    \hline
  \end{tabular}
  }
...
\begin{table}
  ...
  \begin{tabular}{l|cccccc|c|c|c|c|c|c|c|c}
    ...
    $\pTH$ [GeV] & \multicolumn{3}{c|}{0-15}  & \multicolumn{3}{c|}{15-30} & 30-45                      & \multicolumn{2}{c|}{45-80} & 80-120 & 120-200 & 200-350 & 350-600 & 600-$\infty$                           \\
    \hline
    $\hgg$       & \multicolumn{3}{c|}{5.1\%} & \multicolumn{3}{c|}{4.6\%} & 5.1\%                      & \multicolumn{2}{c|}{4.8\%} & 4.9\%  & 4.5\%   & 5.1\%   & 8.6\%   & 32.2\%                                 \\     
    $\hzz$       & \multicolumn{3}{c|}{5.4\%} & \multicolumn{3}{c|}{4.8\%} & \multicolumn{3}{c|}{4.1\%} & \multicolumn{2}{c|}{4.7\%} & \multicolumn{3}{c}{9.1\%}                                                     \\ 
    $\hbb$       & \multicolumn{12}{c|}{none} & 31.4\%                     & 36.8\%                                                                                                                                  \\ 
    Combination  & \multicolumn{3}{c|}{3.7\%} & \multicolumn{3}{c|}{3.3\%} & 4.2\%                      & \multicolumn{2}{c|}{3.7\%} & 4.0\%  & 3.8\%   & 4.4\%   & 8.0\%   & 24.5\%                                 \\
    \hline
  \end{tabular}
  }
...
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{\main/section2/plots/differentials/ATLAS_projectionspectra}
