\asubsubsection[M. Delmastro, T. Klijnsma]{Measurements using $H \to \gamma\gamma$, $H \to ZZ^* \to 4\ell$, (boosted) \Hbb\ decay channels}
\label{sec:diffxs}
...
Sirunyan:2017exp,
Sirunyan:2018sgc%CMS-PAS-HIG-17-028% diff. CMS combination Run II 
...
\asubsubsection[N. Wardle, J. Langford]{Measurement of $p_{T}(H)$ spectrum  in \ttH production mode}
\label{sec:ttHdiffxs}
...
\asubsubsubsection{Analysis strategy}
...
\asubsubsubsection{Differential cross-section results}
