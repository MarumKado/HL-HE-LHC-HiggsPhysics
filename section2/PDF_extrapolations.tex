{\it  Rabah Abdul Khalek, Shaun Bailey,
...
\begin{figure}[t]
\centering
\includegraphics[width=0.67\textwidth]{section2/plots/kinHLLHC.pdf}
\caption{\small 
...
\begin{figure}[t]
  \begin{center}
\includegraphics[width=0.44\linewidth,angle=-90]{section2/plots/resultsPDFs.pdf}
...
\begin{figure}[t]
  \begin{center}
    \includegraphics[width=0.49\linewidth]{section2/plots/xsp-hllhc.pdf}
\includegraphics[width=0.49\linewidth]{section2/plots/xg-hllhc.pdf}
...
\begin{figure}[t]
  \begin{center}
    \includegraphics[width=0.49\linewidth]{section2/plots/ggHiggs.pdf}
    \includegraphics[width=0.49\linewidth]{section2/plots/HiggsJet.pdf}
