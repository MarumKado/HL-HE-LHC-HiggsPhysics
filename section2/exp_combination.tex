...
\asubsubsection{Production mode cross-sections in different decay channels}
...
\scriptsize	
\input{\main/section2/atlas_table_5PD.tex}\hspace{0.5cm}
\input{\main/section2/yr_table_noinc_A1_5PD.tex}
...
\asubsubsection{Cross sections per-production mode}
...
\small
\input{\main/section2/atlas_table_5P.tex}\hspace{0.5cm}
\input{\main/section2/yr_table_noinc_A1_5P.tex}
...
\asubsubsection{Branching ratios per-decay mode}
...
\small
\input{\main/section2/atlas_table_5D.tex}\hspace{0.5cm}
\input{\main/section2/yr_table_noinc_A1_5D.tex}
