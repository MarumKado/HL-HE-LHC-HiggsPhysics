...
%\newpage
The projections documented in this section~\cite{CMS-PAS-FTR-18-011,ATLASPROJECTIONNOTE} are based on the extrapolation of the following analyses:
...
For each projection, the uncertainty is decomposed in four components: statistical, experimental, background theory and signal theory.
...
The correlations between the different production mode cross-sections in different decay channels are in general small, with the exception of the \zh and \wh measurements in the \hzz decay (where given the large anti-correlation also the \vh cross-section is reported) and the  \ggf and \vbf production mode cross sections in the \hmm decay. 
...
\includegraphics[width=0.48\textwidth]{\main/section2/plots/comb/YRCombined_A1_5PD_ggH.pdf}\\
\includegraphics[width=0.48\textwidth]{\main/section2/plots/comb/yr_combined_summary_A1_5PD_3000_VBF.pdf}%
\includegraphics[width=0.48\textwidth]{\main/section2/plots/comb/YRCombined_A1_5PD_VBF.pdf}%
...
\includegraphics[width=0.48\textwidth]{\main/section2/plots/comb/YRCombined_A1_5PD_WH.pdf}\\
\includegraphics[width=0.48\textwidth]{\main/section2/plots/comb/yr_combined_summary_A1_5PD_3000_ZH.pdf}%
\includegraphics[width=0.48\textwidth]{\main/section2/plots/comb/YRCombined_A1_5PD_ZH.pdf}%
...
\includegraphics[width=0.48\textwidth]{\main/section2/plots/comb/YRCombined_A1_5PD_ttH.pdf}
...
\begin{table}[hbtp]
\centering
\caption{The expected $\pm 1\sigma$ uncertainties, expressed as percentages, on the per-production-mode cross sections in the different decay modes  for ATLAS (left) and CMS (right). Values are given for both S1 (with Run~2 systematic uncertainties~\cite{Sirunyan:2018koj}) and S2 (with YR18 systematic uncertainties). The total uncertainty is decomposed into four components: statistical (Stat), signal theory (SigTh), background theory (BkgTh) and experimental (Exp).\wip{add combined S2 results}}
\scriptsize	
...
\includegraphics[width=0.48\textwidth]{\main/section2/plots/comb/YRCombined_A1_5P.pdf}%
...
\begin{table}[hbtp]
\centering
\caption{The expected $\pm 1\sigma$ uncertainties, expressed as percentages, on the per-production-mode cross sections normalized to the SM values  for  ATLAS (left) and CMS (right). Values are given for both S1 (with Run~2 systematic uncertainties~\cite{Sirunyan:2018koj}) and S2 (with YR18 systematic uncertainties). The total uncertainty is decomposed into four components: statistical (Stat), signal theory (SigTh), background theory (BkgTh) and experimental (Exp).\wip{add combined S2 results}}
\small
...
\includegraphics[width=0.48\textwidth]{\main/section2/plots/comb/YRCombined_A1_5D.pdf}%
...
\begin{table}[hbtp]
\centering
\caption{The expected $\pm 1\sigma$ uncertainties, expressed as percentages, on the Higgs boson branching ratios normalized by the SM expectations for ATLAS (left) and CMS (right). Values are given for both S1 (with Run~2 systematic uncertainties~\cite{Sirunyan:2018koj}) and S2 (with YR18 systematic uncertainties). The total uncertainty is decomposed into four components: statistical (Stat), signal theory (SigTh), background theory (BkgTh) and experimental (Exp).\wip{add  combined S2 results}}
\small
...
The correlations range up to XXXX, and are largest between modes where the sensitivity is dominated by gluon-fusion production. This reflects the impact of the theory uncertainties affecting the SM prediction of the gluon-fusion production rate.
