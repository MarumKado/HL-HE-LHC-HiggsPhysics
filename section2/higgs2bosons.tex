\asubsubsection[S. Falke]{$H \to \gamma\gamma$}
...
\asubsubsection[ Y. Huang]{$H \to Z\gamma \to \ell\ell\,\gamma$}
%%{\it To be written by: M. Delmastro}
...
\asubsubsection[A. Gabrielli, A. Schaffer, V. Walbrecht]{$H \to ZZ^* \to 4\ell$}
%% {\it To be written by: M. Delmastro}
...
\asubsubsection[R. Gugel, K. Koeneke]{$H \to WW^* \to \ell\nu\,\ell\nu$}
%% {\it To be written by: M. Delmastro}
