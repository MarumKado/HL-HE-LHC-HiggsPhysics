...
\small
\input{\main/section2/atlas_table_K2.tex}\hspace{0.5cm}
\input{\main/section2/yr_table_K2.tex}
...
\small
\input{\main/section2/atlas_table_L1.tex}\hspace{0.5cm}
\input{\main/section2/yr_table_L1.tex}
\label{tab:summary_L1}
\vspace{0.5cm}
\end{table}


\subsubsection{Higgs boson coupling properties measurements at HE-LHC}
