\asubsubsection[A. Calandri, M. Schr\"oder]{Measurements in \ttH and \tH production modes}
...
\asubsubsubsection{Sensitivity to \ttH production in the \bbbar and multi-lepton final states}
...
Studies in the channel of the boosted regime using substructure
...
side-bands in the invariant mass distribution. This study confirms the statistical power 
of the analysis and the side-bands, but would require a more detailed study of the 
...
\asubsubsubsection[K. Mazumdar, P. Das]{Sensitivity to \tH production}
...
\asubsubsection[T. Klijnsma]{Constraints from differential measurements}
