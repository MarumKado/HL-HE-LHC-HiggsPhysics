...
\begin{figure}
  \centering
  \begin{tabular}{@{}c@{}c@{}}
    \includegraphics[width=0.49\textwidth]{\main/section2/plots/bblj_XS_postfit.eps} &
    \includegraphics[width=0.49\textwidth]{\main/section2/plots/bbdilep_XS_postfit.eps} \\
  \end{tabular}  
  \caption{
...
\begin{figure}
  \centering
    \begin{tabular}{@{}c@{}c@{}}
    \includegraphics[width=0.49\textwidth]{\main/section2/plots/MLwithTau_XS_postfit.eps} &
    \includegraphics[width=0.49\textwidth]{\main/section2/plots/MLnoTau_XS_postfit.eps} \\
  \end{tabular}  
  \caption{
