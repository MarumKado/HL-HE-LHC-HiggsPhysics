...
the SM Lagrangian via gauge-invariant dimension-six operators in \eq{EFTLAG} and estimates the reach on the Wilson coefficients provided by a global analysis, that is, an analysis with muktiple observables and coefficients.
