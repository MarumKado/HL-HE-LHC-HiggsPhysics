...
\begin{figure}[h]
\centering
  %\hspace{-0.1cm}\includegraphics[width=.8\textwidth]{./Figs/HLLHC_Univ_L95}
  \hspace{-0.1cm}\includegraphics[width=.8\textwidth]{\main/section8/Figs/HLLHC_Univ_L95}
  \vspace{-0.2cm}
...
\begin{figure}[h]
\centering
  %\hspace{-0.1cm}\includegraphics[width=.8\textwidth]{./Figs/HELHC_Univ_L95}
  \hspace{-0.1cm}\includegraphics[width=.8\textwidth]{\main/section8/Figs/HELHC_Univ_L95}
  \vspace{-0.2cm}
