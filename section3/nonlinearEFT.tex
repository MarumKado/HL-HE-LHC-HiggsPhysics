\asubsubsection[G. Buchalla, A. Celis, M. Capozi, G. Heinrich,
  L. Scyboz]{Di-Higgs production in the non-linear EFT with full
  $m_t$-dependence at NLO QCD}

\asubsubsubsection{The Higgs sector in the non-linear EFT framework}
...
Section~\ref{sec2:theo_kappa_EFT}.
...
\asubsubsubsection{Total cross sections for 14 and 27 \UTeV at some benchmark points}
...
The results at 14\,\UTeV and 27\,\UTeV are given in Table~\ref{sigmatot}.
...
&&&[\%] &[\%] &\\
\hline
$    B_{5a}$ [14 \UTeV] & 38.64 & 1.78& ${+4, \; -12}$ &0.24  &1.17  \\ 
$    B_{5a}$ [27 \UTeV] & 198.64 & 1.75 & ${+2, \; -10}$ & 0.43 & 1.56  \\ 
\hline
$    B_{6}$ [14 \UTeV] &  24.69 & 1.89 & ${+2, \; -11}$ & 2.1 & 0.75 \\ 
$    B_{6}$ [27 \UTeV] &  97.25 &  1.58& ${+1, \; -6}$ &1.6  & 0.76  \\ 
\hline
$   B_7$ [14 \UTeV] & 169.41 & 2.07& ${+9, \; -12}$ & 2.2 & 5.14 \\
$   B_7$ [27 \UTeV] & 598.20 & 2.11 & ${+8, \; -10}$ & 2.0 &  4.68\\
\hline 
$   B_{8a}$ [14 \UTeV] & 41.70 & 2.34& ${+6, \; -9}$ & 0.63 & 1.27 \\
$   B_{8a}$ [27 \UTeV] & 179.52 & 2.33 & ${+4, \; -7}$ & 0.49 & 1.40 \\
\hline 
$   SM $ [14 \UTeV] & 32.95 & 1.66 & ${+14, \; -13}$ & 0.1 & 1\\
$   SM $ [27 \UTeV] & 127.7&  1.62 & ${+12, \; -10}$ & 0.1 & 1\\
\hline
\end{tabular}
\end{center}
\caption{Total cross sections at 14 and 27 \UTeV at NLO (2nd column),
...
% \end{table}
Table~\ref{sigmatot} shows that the total cross sections increase by a factor of 3.5-5 when increasing the centre-of-mass energy from 14\,\UTeV to 27\,\UTeV. The increase for $B_{5a}$ is largest because of the large value of $\cgg$, which yields a contribution growing linearly with energy.

%\clearpage


\asubsubsubsection{HH  invariant mass distributions at 14 and 27 \UTeV at some benchmark points}
...
\caption{Higgs boson pair invariant mass distributions  for benchmark point 7, $\chhh=5,\ct= 1, \ctt=0, \cg=2/15,\cgg=1/15$, at 14\,\UTeV (left) and 27\,\UTeV (right).}
...
\caption{Higgs boson pair invariant mass distributions  for benchmark point 8a, $\chhh=1,\ct= 1, \ctt=0.5, \cg=4/15,\cgg=0$, at 14\,\UTeV (left) and 27\,\UTeV (right).}
...
\asubsubsubsection{Characterising the BSM parameter space}
...
$\sigma_{SM}^{\rm{LO}}[14\,\mathrm{\UTeV}]=19.85$\,fb,
$\sigma_{SM}^{\rm{NLO}}[14\,\mathrm{\UTeV}]=32.95$\,fb.
...
\end{center}
\caption{Iso-contours of $\sigma/\sigma_{SM}$: (a) $\chhh$ versus $\ctt$ and (b) $\chhh$ versus $\cgg$  at $\sqrt{s}=14$\,\UTeV.}
\label{fig:chhh_ctt_cgg}
\end{figure}

Fig.~\ref{fig:chhh_ctt_cgg} shows variations of the triple Higgs coupling $\chhh$ in combination with $\ctt$ and $\cgg$ at $\sqrt{s}=14$\,\UTeV.
...
\end{center}
\caption{K-factors for the total cross section at $\sqrt{s}=14$\,\UTeV as a function of the
  different couplings.}
...
\end{center}
\caption{3-dimensional visualisation of the $\mhh$ distribution (in units of fb/\UGeV) at 14\,\UTeV as a function of (a) $\ctt$  and (b) $\cgg$.  In case (a) all
...
section and the $\mhh$ distributions at both 14\,\UTeV and 27\,\UTeV are
