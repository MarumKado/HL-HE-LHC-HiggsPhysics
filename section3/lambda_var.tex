\subsubsection{Probing the Higgs boson self-coupling in di-Higgs
...
\subsubsection{Total cross sections at different values of the trilinear coupling}
...
\subsubsection{Differential cross sections  at 14 TeV and 27 TeV}
...
\begin{figure}[htb]
  \centering
  \subfloat[]{\label{fig:lambda_small_14}\includegraphics[width=0.6\textwidth]{section3/plots/mhh_Kfac_14TeV_varylambda_small.pdf}}
  %\hfill
