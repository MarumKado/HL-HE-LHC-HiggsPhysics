...
\begin{figure}[!htb]
\centering 
\subfloat[]{\label{fig:ATLAS_HH_4b_a}\includegraphics[width=0.5\textwidth]{\main/section3/plots/ATLAS_4b_LimitVsSyst.pdf}} 
\subfloat[]{\label{fig:ATLAS_HH_4b_b}\includegraphics[width=0.5\textwidth]{\main/section3/plots/EXOT-2016-31_fig_04b.pdf}}
...
\begin{figure}[!htb]
\centering 
\subfloat[]{\label{fig:ATLAS_HH_bbtautau_a}\includegraphics[width=0.5\textwidth]{\main/section3/plots/HIGG-2016-16_fig_01a.pdf}} 
\subfloat[]{\label{fig:ATLAS_HH_bbtautau_b}\includegraphics[width=0.5\textwidth]{\main/section3/plots/HIGG-2016-16_fig_01c.pdf}}\\
\subfloat[]{\label{fig:ATLAS_HH_bbtautau_c}\includegraphics[width=0.5\textwidth]{\main/section3/plots/HIGG-2016-16_fig_01e.pdf}}
...
\begin{figure}[!htb]
\centering 
\subfloat[]{\label{fig:ATLAS_HH_bbyy_a}\includegraphics[width=0.5\textwidth]{\main/section3/plots/ch03_fig_033.pdf}} 
\subfloat[]{\label{fig:ATLAS_HH_bbyy_b}\includegraphics[width=0.5\textwidth]{\main/section3/plots/mbbyy_SignalBackground_20GeVbins_variouskappa.pdf}} 
...
\begin{figure}[!htb]
\centering 
\subfloat[statistical uncertainties only]{\label{fig:ATLAS_HH_comb_a}\includegraphics[width=0.5\textwidth]{\main/section3/plots/bbbb_bbtt_bbyy_lHHH0100_NoSyst_overlay_Internal.pdf}} 
\subfloat[systematic uncertainties included]{\label{fig:ATLAS_HH_comb_b}\includegraphics[width=0.5\textwidth]{\main/section3/plots/bbbb_bbtt_bbyy_lHHH0100_AllSyst_overlay_Internal.pdf}} 
