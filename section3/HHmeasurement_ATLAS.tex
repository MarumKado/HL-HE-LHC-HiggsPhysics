...
\begin{figure}[!htb]
\centering 
\subfloat[]{\label{fig:ATLAS_HH_a}\includegraphics[width=0.5\textwidth]{\main/section3/ch03_fig_033.pdf}} 
\subfloat[]{\label{fig:ATLAS_HH_b}\includegraphics[width=0.5\textwidth]{\main/section3/ch03_fig_035a.pdf}} 
