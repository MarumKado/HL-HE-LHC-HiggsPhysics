...
%---------------------------------------------
\begin{figure*}[t]
  \includegraphics[width=0.32\textwidth]{Plot_mhh_27TeV}
  \includegraphics[width=0.32\textwidth]{Plot_pth_27TeV}
  \includegraphics[width=0.32\textwidth]{Plot_draa_27TeV}
...
\begin{figure*}[b!]
\centering 
 \includegraphics[width=.4\textwidth]{hh_5sigma_2b3j} 
 \includegraphics[width=.4\textwidth]{hh_5sigma_width}
...
\begin{figure}[t!]
\centering 
  \includegraphics[width=.4\textwidth]{hh_dlamb}
