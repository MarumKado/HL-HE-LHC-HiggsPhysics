\subsubsection{Theoretical prospects: from kinematics to dynamics\footnote{Contacts: Dorival Gon\c{c}alves, Tao Han, Felix Kling, Tilman Plehn and Michihisa Takeuchi}}
\label{sec:THanetal}
%\begin{center}
...
\subsubsection{Theoretical prospects: detailed contribution from the ggF background \footnote{Contacts: Samuel Homiller and Patrick Meade}}
\label{sec:Homilleretal}
