...
and subsequent studies; the assumptions used for this report and a more detailed description are available in Ref.~\cite{ATLAS_PERF_Note,CMS_PERF_Note}. For CMS, the object performance in the central region assumes a barrel calorimeter aging corresponding to an integrated luminosity of $1000$~fb$^{-1}$.
...
Electrons and photons are reconstructed from energy deposits in the electromagnetic calorimeter and information from the inner tracker\cite{ATLAS_LAr_TDR,CMS_Barrel_TDR,CMS_HGCAL_TDR,CMS_MTD_TP}.
