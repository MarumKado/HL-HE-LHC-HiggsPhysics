...
% The main document.
\begin{document}
\newcommandx{\asection}[3][1=NONE, 2=NONE]{
  \ifthenelse{\equal{#1}{NONE}}
  {\section{#3}}{\section[#3]{#3\footnote{Contact Editors:
        #1}\ifthenelse{\equal{#2}{NONE}}
      {}{$^{,\,}$\footnote{Contacts: #2}}}}}
\newcommandx{\asubsection}[3][1=NONE, 2=NONE]{
  \ifthenelse{\equal{#1}{NONE}}
  {\subsection{#3}}{\subsection[#3]{#3\footnote{Contacts:
        #1}\ifthenelse{\equal{#2}{NONE}}
      {}{$^{,\,}$\footnote{FIXME: #2}}}}}
\newcommandx{\asubsubsection}[3][1=NONE, 2=NONE]{
  \ifthenelse{\equal{#1}{NONE}}
  {\subsubsection{#3}}{\subsubsection[#3]{#3\footnote{Contacts:
        #1}\ifthenelse{\equal{#2}{NONE}}
      {}{$^{,\,}$\footnote{FIXME: #2}}}}}
\newcommandx{\asubsubsubsection}[3][1=NONE, 2=NONE]{
  \ifthenelse{\equal{#1}{NONE}}
  {\subsubsubsection{#3}}{\subsubsubsection[#3]{#3\footnote{Contacts:
        #1}\ifthenelse{\equal{#2}{NONE}}
      {}{$^{,\,}$\footnote{FIXME: #2}}}}}
\newcommand{\main}{.}
