...
% The main document.
\begin{document}
\newcommand{\asection}[2][]{\ifthenelse{\equal{#1}{}}
  {\section{#2}}{\section[#2]{#2\footnote{#1}}}}
\newcommand{\asubsection}[2][]{\ifthenelse{\equal{#1}{}}
  {\subsection{#2}}{\subsection[#2]{#2\footnote{#1}}}}
\newcommand{\asubsubsection}[2][]{\ifthenelse{\equal{#1}{}}
  {\subsubsection{#2}}{\subsubsection[#2]{#2\footnote{#1}}}}
\newcommand{\main}{.}
