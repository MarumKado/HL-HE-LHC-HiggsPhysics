...
\caption{Projected  uncertainties on $\kappa_i$, combining ATLAS and CMS: total (grey box), statistical (blue), experimental (green) and theory (red). See Section~\ref{sec2:prec} for details.
...
\includegraphics[width=0.50\textwidth]{section10/img/Yukawa} 
    \caption{Summary of the projected HL-LHC limits on the quark
      Yukawa couplings. See Section~\ref{sec7:flavor} for details. \label{fig:HiggsFlavor}
      }
\end{center}
\end{figure}
...
\caption{Sensitivity to BSM Higgs bosons, in the $H/A\to\tau\tau$ channel. See Section~\ref{sec9:BSM} for details.
\label{fig:HiggsBSM}
 }
  \end{center}
\end{figure}
