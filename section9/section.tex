...
% commented out to allow the circulation, since approval is not likely by the version1 submission deadline 
% it must be uncommented as soon as FTR-18-035 is approved! (certainly for version2)





\subsection{Searches for additional neutral Higgs bosons in fermionic final states}\label{sec:Hff}
