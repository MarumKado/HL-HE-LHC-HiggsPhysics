...
\subsection{Additional channels for heavy Higgs bosons}
...
\subsection{New Higgs bosons below the 125 GeV Higgs mass}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsubsection{Introduction}\label{sec:intro}
