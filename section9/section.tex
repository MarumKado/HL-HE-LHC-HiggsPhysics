...
\subfile{\main/section9/mssmtautau}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.48\textwidth]{\main/section9/plots/2HDM_AZH_Plot_Statistics.pdf}
\includegraphics[width=0.48\textwidth]{\main/section9/plots/2HDM_AZH_Plot_Statistics.pdf}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=0.65\textwidth]{\main/section9/plots/95_exclusion_map_HAA.pdf}
