...
\section{Searches for beyond the standard model Higgs physics\label{sec9:BSM}}

%\subfile{\main/section9/mssm_2hdm}

\subsection{Exotic decays of the 125 GeV Higgs boson}
...
\subsection{LHC searches for additional neutral Higgs bosons in fermionic final states}\label{sec:Hff}
\subfile{\main/section9/cms_htt/cms_htt}
\subfile{\main/section9/atlas_htt}

\subsection{LHC searches for additional neutral Higgs bosons in bosonic final states}\label{sec:XZZ}
%Commented out for CDS upload because CMS FTR-18-040 results have not been approved
%\subfile{\main/section9/cms_xzz}

\subsection{New channels for heavy Higgs bosons}
...
\subsubsection{Probing new displaced heavy Higgs bosons at the HL-LHC}
\subfile{\main/section9/twin_higgs}

\subsubsection{Interference effects in heavy Higgs searches}
\subfile{\main/section9/HHinterference}\footnote{This manuscript has been authored by Fermi Research Alliance, LLC under Contract No. DE-AC02-07CH11359 with the U.S. Department of Energy, Office of Science, Office of High Energy Physics. ZL is also supported by the NSF under Grant No. PHY1620074 and by the Maryland Center for Fundamental Physics (MCFP).}
