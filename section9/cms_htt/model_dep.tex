...
%Generally, MSSM scenarios incorporate the $125\,\GeV$ Higgs boson as the lighter scalar $\textrm{h}$ 
...
\begin{figure}[htbp]
\begin{center}
\subfloat[$\mhmodp$]{\includegraphics[width=0.45\textwidth]{\main/section9/cms_htt/figures/mssm_mhmod_jul31_scen2_pas.pdf}}\\
\subfloat[hMSSM]{\includegraphics[width=0.45\textwidth]{\main/section9/cms_htt/figures/mssm_hmssm_jul31_scen2_pas.pdf}}
\subfloat[tau-phobic]{\includegraphics[width=0.45\textwidth]{\main/section9/cms_htt/figures/mssm_tauphobic_aug03_scen2_pas.pdf}}
\end{center}
