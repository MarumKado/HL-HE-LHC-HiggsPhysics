\asubsubsection[C. Caillol]{Projection of CMS search for exotic $\PH\to aa \to 2b 2\tau$}\label{Sec:9.1.3}
...
\asubsubsection[C. Caillol]{Projection of CMS search for exotic $\PH\to aa \to 2\mu 2\tau$}
