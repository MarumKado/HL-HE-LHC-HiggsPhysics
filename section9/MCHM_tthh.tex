...
couple hundred GeV is taken into account to a first approximation by using a running top mass of $\bar{m}_t = 150$ GeV for the diagonalisation of the mass
matrix, and of $m_t = 173$ GeV, for the kinematic quantities.   We take the Higgs mass as an independent parameter,
