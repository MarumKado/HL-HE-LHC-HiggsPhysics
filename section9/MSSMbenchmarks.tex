...
correlation matrix, as evaluated by the ATLAS and CMS experiment assuming YR18 systematic uncertainties (S2), see Sec.~\ref{sec:2:exp_kappa}, Tab.~\ref{tab:summary_A1_5PD}.  We furthermore take cross-correlations of theoretical
