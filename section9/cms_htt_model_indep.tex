...
\begin{figure}[htbp]
\begin{center}
\subfloat[ggH]{\includegraphics[width=0.45\textwidth]{\main/section9/plots/scen2_ggH_pas.pdf}}
\subfloat[bbH]{\includegraphics[width=0.45\textwidth]{\main/section9/plots/scen2_bbH_pas.pdf}}
\end{center}
...
\begin{figure}[htbp]
\begin{center}
\subfloat[$ggH$]{\includegraphics[width=0.45\textwidth]{\main/section9/plots/3000fb_ggH_pas.pdf}}
\subfloat[$bbH$]{\includegraphics[width=0.45\textwidth]{\main/section9/plots/3000fb_bbH_pas.pdf}}
\end{center}
...
\begin{figure}[htbp]
\begin{center}
\subfloat[$ggH$]{\includegraphics[width=0.45\textwidth]{\main/section9/plots/2D_limit_mH125.pdf}}
\subfloat[$ggH$]{\includegraphics[width=0.45\textwidth]{\main/section9/plots/2D_limit_mH400.pdf}}\\
\subfloat[$ggH$]{\includegraphics[width=0.45\textwidth]{\main/section9/plots/2D_limit_mH700.pdf}}
\subfloat[$ggH$]{\includegraphics[width=0.45\textwidth]{\main/section9/plots/2D_limit_mH3200.pdf}}
\end{center}
