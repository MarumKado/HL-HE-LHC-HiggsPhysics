...
%%\begin{document}
\footnote{{\bf Authors: Marcela Carena$^{a,b,c}$, and Zhen Liu$^{a,d}$, Marc Riembau$^{e.f}$}\\
...
\begin{figure}[t]  
  \centering
  \includegraphics[width=.60\textwidth]{\main/section9/HHinterference/linearlineshape}
...
\subsubsection*{Discovery and exclusion reach at the HL- and HE-LHC} 
...
\begin{figure}[t]
  ...
  \includegraphics[width=1\textwidth]{\main/section9/HHinterference/hllhc_projections.pdf}
...
\includegraphics[width=1\textwidth]{\main/section9/HHinterference/helhc_projections.pdf}
  \caption{
