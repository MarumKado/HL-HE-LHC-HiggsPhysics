...
\newcommand*{\ATLASLATEXPATH}{\main/section9/atlas_htautau/latex/}
...
% Add you own definitions here (file mssmtautau-defs.sty).
...
\begin{figure}[!ht]
    \centering
        \subfloat[\lephad $b$-veto category]{\includegraphics[width=0.45\columnwidth]{\main/section9/atlas_htautau/figures/c170_postfit_lephad_bveto_MTtot__highlumi.pdf}}
        \qquad
        \subfloat[\lephad $b$-tag category]{\includegraphics[width=0.45\columnwidth]{\main/section9/atlas_htautau/figures/c171_postfit_lephad_btag_MTtot__highlumi.pdf}}
        \qquad
        \subfloat[\hadhad $b$-veto category]{\includegraphics[width=0.45\columnwidth]{\main/section9/atlas_htautau/figures/c20_postfit_hadhad_bveto_MTtot__highlumi.pdf}}
        \qquad
        \subfloat[\hadhad $b$-tag category]{\includegraphics[width=0.45\columnwidth]{\main/section9/atlas_htautau/figures/c21_postfit_hadhad_btag_MTtot__highlumi.pdf}}
...
\begin{figure}[!ht]
    \centering
        \qquad
        \includegraphics[width=0.5\columnwidth]{\main/section9/atlas_htautau/figures/c181_postfit_lephad_tcr_MTtot__highlumi.pdf}
...
%In Figure \ref{fig:sysimpact} (a), the peak structure at $\SI{1}{\TeV}$ 
...
%\begin{figure}[!ht]
%    \centering
%        \subfloat[gluon--gluon fusion production]{\includegraphics[width=0.4\columnwidth]{\main/section9/atlas_htautau/figures/ggH__syst_impacts.pdf}}
 %       \qquad
%        \subfloat[$b$-associated production]{\includegraphics[width=0.4\columnwidth]{\main/section9/atlas_htautau/figures/bbH__syst_impacts.pdf}}
...
\begin{figure}[!ht]
    \centering
        \subfloat[gluon--gluon fusion production]{\includegraphics[width=0.4\columnwidth]{\main/section9/atlas_htautau/figures/ggH.pdf}}
        \qquad
        \subfloat[$b$-associated production]{\includegraphics[width=0.4\columnwidth]{\main/section9/atlas_htautau/figures/bbH.pdf}}
...
\begin{figure}[!ht]
    \centering
        \subfloat[hMSSM scenario]{\includegraphics[width=0.4\columnwidth]{\main/section9/atlas_htautau/figures/hMSSM.pdf}}
        \qquad
        \subfloat[\mhmodp scenario]{\includegraphics[width=0.4\columnwidth]{\main/section9/atlas_htautau/figures/mhmodp.pdf}}
