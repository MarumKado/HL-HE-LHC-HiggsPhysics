...
LHC will accumulate 3\abinv of proton-proton (\pp) collisions at 14\TeV.
...
We focus on small or moderate decay lengths of the new particles, 1--50\mm, and assume, as is demonstrated by
...
\begin{enumerate}
\item Displaced single muons, generated with a uniform distribution of transverse momentum (\pt) between 2 and 8\GeV, uniform
in $\eta$ between -1 and 1, and with impact parameter \dtrans distributed as a Gaussian with width $\sigma=2\cm$.
\item The decay of the SM Higgs boson $\PH(125)\to \phi\phi\to \bbbar\bbbar$, with $\phi$ masses of 15, 30, and 60\GeV, and \ctau of 0, 1, and 5\cm.
...
\item The decay of a heavy SM-like Higgs boson with mass 250\GeV, $\PH(250)\to \phi\phi\to \bbbar\bbbar$, with $\phi$ masses of 15, 30, and 60\GeV, and \ctau of 0, 1, and 5\cm.
...
with a prompt track with $\pt \gtrsim 2\GeV$.
...
For the studies below, \zo bins with size 6 cm are used. Jets with $\ET>50\,(100)\GeV$ are required to have at least two (three) tracks.
...
To mitigate the effect of high-\pt fake tracks, any track with a reconstructed \pt above 200\GeV is assigned a \pt of 200\GeV. The track quality selection used in this analysis
is summarized in Table~\ref{tab:tracksel}. 

\begin{table*}[htb]
\centering
\topcaption{Track selection for jet finding. The $\chi^2$ selections are per degree of freedom for a 4-parameter track fit. \label{tab:tracksel}}
\begin{tabular}{r|ccc}
\hline
track \pt & 4 stubs  & 5 stubs & 6 stubs \\
\hline
2--10\GeV   & $\chi^2<15$ & $\chi^2<15$ & accept \\
10--50\GeV & reject      & $\chi^2<10$ & accept \\
${>}50\GeV$   & reject      & $\chi^2<5$ & $\chi^2<5$ \\
\hline
\end{tabular}
\end{table*}
...
\HT is computed from track jets with $\pt>5\GeV$.
...
\begin{figure*}[hbtp]\centering
 \includegraphics[width=0.45\textwidth]{\main/section9/jet_eff.png}
...
\begin{figure*}[hbtp]\centering
 \includegraphics[width=0.45\textwidth]{\main/section9/rates_HT.png}
 \includegraphics[width=0.45\textwidth]{\main/section9/rates_Quad.png}
...
\begin{figure*}[hbtp]\centering
 \includegraphics[width=0.49\textwidth]{\main/section9/bends.png}
...
\begin{figure*}[hbtp]\centering
 \includegraphics[width=0.9\textwidth]{\main/section9/stubeff_d0.png}
 ...
 The sample is comprised of 2000 muons generated with uniformly distributed transverse momentum between 2 and 8\GeV and pseudorapidity $|\eta|<1$, and with the impact parameter \dtrans
 distributed as a Gaussian with width of 2\cm.}
  \label{fig:stubeff}
\end{figure*}
...
\begin{figure*}[hbtp]\centering
 \includegraphics[width=0.9\textwidth]{\main/section9/trackeff_d0.png}
...
\begin{table*}[htb]
\centering
\topcaption{Track selection criteria for jet finding with extended L1 track finding. \label{tab:dtracksel}}
...
in a jet have $|\dtrans|>0.1\cm$, the jet is tagged as a displaced jet.
...
\begin{figure*}[hbtp]\centering
 ...
 \includegraphics[width=0.49\textwidth]{\main/section9/reff_h125.png}
 \includegraphics[width=0.49\textwidth]{\main/section9/reff_h250_mphi30.png} \\
 \includegraphics[width=0.49\textwidth]{\main/section9/reff_h125_mphi30.png}
\includegraphics[width=0.49\textwidth]{\main/section9/reff_h250.png}
...
\begin{figure*}[hbtp]\centering
 \includegraphics[width=0.49\textwidth]{\main/section9/rate_disp.png}
...
\begin{figure}[hbtp]
  \centering
    \includegraphics[width=0.49\textwidth]{\main/section9/ExtrapolatedRatemH125_mPhi15.png}
    \includegraphics[width=0.49\textwidth]{\main/section9/ExtrapolatedRatemH250_mPhi30.png}\\
    \includegraphics[width=0.49\textwidth]{\main/section9/ExtrapolatedRatemH125_mPhi30.png}
    \includegraphics[width=0.49\textwidth]{\main/section9/ExtrapolatedRatemH250_mPhi60.png}
...
\begin{figure}[hbtp]
  \centering
    \includegraphics[width=0.49\textwidth]{\main/section9/HiggsM125_25kHzYieldsvsLifetime.png}
    \includegraphics[width=0.49\textwidth]{\main/section9/HiggsM125_5kHzYieldsvsLifetime.png}\\
    \includegraphics[width=0.49\textwidth]{\main/section9/HiggsM250_25kHzYieldsvsLifetime.png}
    \includegraphics[width=0.49\textwidth]{\main/section9/HiggsM250_5kHzYieldsvsLifetime.png}
...
Currently, such events pass the L1 trigger only if the total transverse energy in the event is above a few hundred \GeVns.
