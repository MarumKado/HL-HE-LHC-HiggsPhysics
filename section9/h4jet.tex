...
LHC will accumulate 3\Uiab of proton-proton (\Pp\Pp) collisions at 14\UTeV.
...
The main obstacle is the high rate for low transverse momentum jets, which is made worse by additional extraneous \Pp\Pp collisions in the
...
In these studies, the Phase-2 CMS detector is simulated using \GEANT~\cite{geant}.
...
\item The decay of the SM Higgs boson $\PH(125)\to \phi\phi\to \PQb\PAQb\PQb\PAQb$, with $\phi$ masses of 15, 30, and 60\UGeV, and \ctau of 0, 1, and 5\Ucm.
...
\item The decay of a heavy SM-like Higgs boson with mass 250\UGeV, $\PH(250)\to \phi\phi\to \PQb\PAQb\PQb\PAQb$, with $\phi$ masses of 15, 30, and 60\UGeV, and \ctau of 0, 1, and 5\Ucm.
...
of the muon, as measured in the full \GEANT-based simulation of the Phase-2 detector. 
...
$\sigma_{\Pp\Pp\to \PH(250)} \mathcal{B}[\Phi \to \phi\phi] = 10^{-5} \sigma_{\Pp\Pp\to \PH(125)}$.
...
For the exotic Higgs decays considered, given the total Phase-2 dataset of 3\Uiab and branching fraction of $10^{-5}$, 
