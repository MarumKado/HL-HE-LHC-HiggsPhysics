...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.4\textwidth]{\main/section7/plots/atlas_efficiency_fig_01}
...
Even though the LHCb experiments operates at lower luminosity when compared to ATLAS/CMS, it has unique capabilities for discrimination between $b$- and $c$-jets thanks to its excellent vertex reconstruction system~\cite{Aaij:2015yqa}. 
Its acceptance covers $\sim 5$\% of the associated production of $W/Z+H$ at 13 TeV. The Figure~\ref{fig:hbbetas} shows the coverage of  LHCb for the $b\bar{b}$ produced by the Higgs decay in association with a vector boson. When the two jets are in acceptance, the lepton from $W/Z$ tends to be in acceptance as well ($\sim 60$\% of times). Due to the forward geometry, Lorentz-boosted Higgs bosons are  likely to be properly reconstructed.
...
Neglecting any improvements in the analysis or detector, the extrapolation of the limit obtained at 8\,TeV to 300fb$^{-1}$ at 14\,TeV leads to a sensitivity of $\mu^{cc}\lesssim 50\,$. 
...
Therefore, with these improvements, the expected limit can be pushed down to $\mu^{cc}\lesssim 5-10$ which corresponds to a limit of 2-3 times the Standard Model prediction.
This extrapolation does not include improvements in analysis techniques: for instance  Deep Learning methods can be applied to exploit correlations in  jets substructures properties to reduce the backgrounds.

\begin{figure}[ht]
	\centering
	\includegraphics[width=0.5\linewidth]{\main/section7/plots/hbb_etas.png}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.99\linewidth]{\main/section7/plots/c-tag-eff.png}
...
{\bf YS: I think we can remove this paragraph}
...
{\bf YS: discuss this paragraph as it missleading}
...
% 
These limits are compatible with those obtained from direct limits, such as a search using the same dataset for $\PH\to\PJGy\PGg$ by the ATLAS Collaboration~\cite{Aad:2015sda}, and a search for $\hcc$ by the ATLAS Collaboration~\cite{Aaboud:2018fhh} using data collected at $\sqrt{s}=13$\UTeV, corresponding to an integrated luminosity of $36.1$\fbinv.
% 
...
% 
Recently, the \hyphenation{parametrized} theoretical predictions of the $\pth$ distribution from Ref.~\cite{Bishara:2016jga} and Refs.~\cite{Grazzini:2017szg,Grazzini:2016paz} were fitted to data~\cite{CMS-PAS-HIG-17-028} collected by the CMS Collaboration at $\sqrt{s}=13$\UTeV, corresponding to an integrated luminosity of $36.1$\fbinv.
% 


Here we concern the projection of the constraints on Higgs boson couplings obtained in Ref.~\cite{CMS-PAS-HIG-17-028} to an integrated luminosity of $3000$\fbinv.
% 
...
\begin{figure}[hbtp]
  \begin{center}
    \includegraphics[width=0.49\linewidth]{\main/section7/plots/projection_kbkc_plot_couplingdependentBRs.pdf}
    \includegraphics[width=0.49\linewidth]{\main/section7/plots/projection_kbkc_plot_couplingdependentBRs_scenario2.pdf}
    % 
    \caption{
...
\begin{figure}[hbtp]
  \begin{center}
    \includegraphics[width=0.49\linewidth]{\main/section7/plots/projection_kbkc_plot_floatingBRs.pdf}
    \includegraphics[width=0.49\linewidth]{\main/section7/plots/projection_kbkc_plot_floatingBRs_scenario2.pdf}
    % 
    \caption{
...
\begin{figure}[tb!]
  \begin{center}
 % \hspace*{1.5cm} 
 \includegraphics[width=0.6\textwidth, angle=0]{\main/section7/plots/AsymmetryNLO_HELHC.pdf}
