...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.65\textwidth]{section7/higgs_exclusive_diag.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{section7/higgs_production}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.35\textwidth]{section7/Disteta.pdf}~~~~~~~~
\includegraphics[width=0.35\textwidth]{section7/DistpT.pdf}\\
\includegraphics[width=0.35\textwidth]{section7/normalizedcharm8TeV.pdf}
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=0.35\textwidth]{section7/Naive13TeVy.pdf}~~~~~~
\includegraphics[width=0.35\textwidth]{section7/Naive13TeVpT.pdf}\\
\includegraphics[width=0.35\textwidth]{section7/future12.pdf}
...
% 
Using the transverse momentum distribution measured by the ATLAS Collaboration at $\sqrt{s}=8$\UTeV~\cite{Aad:2015lha}, corresponding to an integrated luminosity of $20.3$\Uifb, for the first time limits were set on the coupling to the charm quark, $\kappac$, using differential distributions~\cite{Bishara:2016jga}.
% 
These limits are compatible with those obtained from direct limits, such as a search using the same dataset for $\PH\to\PJGy\PGg$ by the ATLAS Collaboration~\cite{Aad:2015sda}, and a search for $\hcc$ by the ATLAS Collaboration~\cite{Aaboud:2018fhh} using data collected at $\sqrt{s}=13$\UTeV, corresponding to an integrated luminosity of $36.1$\Uifb.
% 
...
% 
Recently, the \hyphenation{parametrized} theoretical predictions of the $pTH$ distribution from Ref.~\cite{Bishara:2016jga} and Refs.~\cite{Grazzini:2017szg,Grazzini:2016paz} were fitted to data~\cite{CMS-PAS-HIG-17-028} collected by the CMS Collaboration at $\sqrt{s}=13$\UTeV, corresponding to an integrated luminosity of $36.1$\Uifb.
% 
This section concerns the projection of the constraints on Higgs boson couplings obtained in Ref.~\cite{CMS-PAS-HIG-17-028} to an integrated luminosity of $3000$\Uifb.
% 
We report projections for the simultaneous fits to data of $\kappac$ and $\kappab$ and of $\kappat$ and $\cg$, using projections of the differential distributions at $3000$\Uifb obtained elsewhere \textbf{[Ref to pure diff xs projection here]}.



The Higgs boson coupling fits are based a combination of $pTH$ distributions from the $\hgg$~\cite{Sirunyan:2018kta} and $\hzzllll$~\cite{CMS_AN_2016-442} (where $\ell = \Pe$ or $\Pgm$) decay channels obtained at $\sqrt{s}=13\,$TeV.
% 
Furthermore, a search for the Higgs boson produced with large \pt and decaying to a bottom quark-antiquark ($\PQb\PAQb$) pair~\cite{CMS_AN_2016-366}, which enhances the sensitivity at high $pTH$, is included in the $\kappat/\cg$ fit.
% 
