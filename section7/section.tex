...
The Higgs production and decay signal strengths from the CMS collaboration (most recent at the time of writing)~\cite{} which includes the direct observation of $t\bar t h$ production are
\begin{align}
    \mu^{bb}=1.12^{+0.29}_{-0.29}, & \mu^{\tau\tau}}
    \mu^{\mu\mu}=0.68^{+1.25}_{-1.24}, & 
\end{align}
