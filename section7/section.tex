...
\section{Higgs flavor and rare decays\label{sec7}}

\begin{center}
{\it Edited by Kostas Nikopoulos, Alexander Schmidt, Lorenzo Sestini, Yotam Soreq}
\end{center}
...
probes of the different Higgs Yukawa couplings, such as kinematical
...
generically well below these bounds. A summary of the projected limits on $\kappa_{c,s,d,u}$ is given in Fig.~\ref{fig:sec7:summary} using the methods outlined in this section: exclusive decays of the Higgs, fits of differential cross-sections, constraints from the total Higgs width assuming a value of $200~\mathrm{MeV}$, a global fit of Higgs production cross-sections, and direct searches for a $c\bar{c}$ final state.
\begin{figure}
    \centering
    \includegraphics[width=0.3\textwidth]{section7/plots/flavor_summary.pdf}
...
\begin{center}
{\it by Oscar Augusto De Aguiar Francisco,  Matthias Schlaffer, Lorenzo Sestini and Emmanuel Stamou}
\end{center}
...
\subsection{Lepton flavor violating decays of the Higgs}
\begin{center}
{\it by Maria Cepeda and Yotam Soreq}
\end{center}
...
\begin{center}
{\it by Felix Yu, Alexander Schmidt, Thomas Klijnsma and Yotam Soreq}
\end{center}
...
CMS interpertated the 13\,TeV Higgs $p_T$ spectrum with luminosity of $35.9\,$fb$^{-1}$ to obtain bounds on the $c$ and $b$ Yukawa couplings~\cite{CMS-PAS-HIG-17-028}. The resulting 95\,\% CL intervals are
%
\begin{align}
...
\begin{center}
{\it by 
Emanuel Gouevia, Roni Harnik, Lukas Lechner, Yichen Li, Adam Martin, Antonio Onofre, Robert Schoefbeck, Daniel Spitzbart and Eleni Vryonidou}
\end{center}
